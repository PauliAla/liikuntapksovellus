    ...
    <>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '400px' }}>
        ...
        <div class="form-group text-center"  >
            <span class="img-div">
              <div class="text-center img-placeholder"  onClick="triggerClick()">
                <h4>Päivitä kuva sijainnista</h4>
              </div>
              <img src="images/avatar.jpg" onClick="triggerClick()" id="profileDisplay"></img>
            </span>
            <input type="file" name="profileImage" id="profileImage" class="form-control" ></input>
        ...
        <div class="form-group text-center"  >
            <span class="img-div">
              <div class="text-center img-placeholder"  onClick="triggerClick()">
                <h4>Päivitä kuva suorituksesta</h4>
              </div>
              <img src="images/avatar.jpg" onClick="triggerClick()" id="profileDisplay"></img>
            </span>
            <input type="file" name="profileImage" id="profileImage" class="form-control" ></input>
