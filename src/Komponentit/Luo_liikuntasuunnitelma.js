...
function Luo_liikuntasuunnitelma() {
    ...
    <>
      ...
      <div className="container-fluid px-5 mt-4">
                <div className="row">
                    ...
                    <Link to="/Etusivu" className="lisaa btn btn-primary py-1">Takaisin liikuntasuunnitelmaan</Link>
                    <br></br>
                    <br></br>
                    <Link to="/luo_Liikuntasuunnitelma" className="lisaa btn btn-primary py-1">Luo liikuntasuunnitelma</Link></div>
                 
                    <h4 className="mt-2 fw-bold">Tämä hetkinen Liikuntasuunnitelma:</h4> 
...
export default Luo_liikuntasuunnitelma;